...
import {UserProfilebApi} from '../admin/admin-user-manager/admin-user-manager.component';
...
export class AdminExchangeService {
  ...
  searchUserTransaction(page: number, size: number, buyer: string, seller: string, productName: string, firstDateSt: string, lastDateSt: string, status: string) {
